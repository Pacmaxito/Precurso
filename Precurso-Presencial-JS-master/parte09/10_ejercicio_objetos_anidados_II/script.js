let letraNombre = {
    ...
    Usuario.Fecha = FechaDeNacimiento;

    let nombrePregunta = prompt("¿Cual es tu nombre real?");
    Usuario.nombre = nombrePregunta;

    let ApellidoPregunta = prompt("¿Cual es tu apellido?");
    Usuario.Apellido = ApellidoPregunta;

    let letraNombreDato = nombrePregunta.substring(0,1);
    console.log(letraNombreDato);
    
    let letraApellidoDato = ApellidoPregunta.substr(-1);
    console.log(letraApellidoDato);

    let fechaDato = FechaDeNacimiento.substr(-1);
    console.log(fechaDato);
    
    // log de nombre
     let Supernombre = letraNombre[letraNombreDato].masculino;

    // log de apellido
    let Superapellido = letraApellido[letraApellidoDato].masculino;
