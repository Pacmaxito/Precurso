let randomObject ={
    ...
    let valorBoard = randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board;
   

    console.log(valorBoard);
    let namePregunta = prompt("¿Cómo te llamas?");
    randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board.name = namePregunta;

    let valorname = randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board.name = namePregunta;
